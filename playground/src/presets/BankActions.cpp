    ...
    m_presetManager(presetManager)
{
  ...
  addAction("append-named-preset", [&] (shared_ptr<NetworkRequest> request) mutable
  {
                                                ...
                                                const Glib::ustring& fileName, const Glib::ustring& lastModified)
{
  ...
  newBank->undoableSetAttribute(transaction, "Date of Import File", DateTimeInfo::formatTime(lastModifiedSeconds, "%FT%T%z"));
