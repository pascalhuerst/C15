...
bool PlayControlParameterEditLayout2::onRotary (int inc, ButtonModifiers modifiers)
{
...
bool PlayControlParameterEditLayout2::isModeSupported (uint8_t desiredMode) const
{
  return desiredMode == Mode::Behaviour || super2::isModeSupported (desiredMode);
}

void PlayControlParameterEditLayout2::setMode (uint8_t desiredMode)
{
